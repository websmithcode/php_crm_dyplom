...
<aside class="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark vh-100 position-fixed" id="sidebar">
    ...
    <ul class="nav nav-pills flex-column mb-auto">
        ...
        <?php if (!empty($_SESSION['user'])): ?>
            <li class="nav-item">
                <a href="/reference/"
                   class="nav-link text-white <?= Functions::getAppName() == 'Reference' ? 'active' : '' ?>">
            ...
            <li class="nav-item">
                <a href="/orders/"
                   class="nav-link text-white <?= Functions::getAppName() == 'Orders' ? 'active' : '' ?>">
            ...
            <li class="nav-item">
                <a href="/handbook/"
                   class="nav-link text-white <?= Functions::getAppName() == 'Handbook' ? 'active' : '' ?>">
                    <i class="bi bi-gear-fill"></i>
                    Справочники
                </a>
                <ul class="nav nav-pills flex-column ms-5 mb-2">
                    <li class="nav-item">
                        <a href="/handbook/prints/"
                           class="text-white text-decoration-none <?= Functions::getActionName() == 'prints' ? 'text-decoration-underline' : '' ?>"
                           aria-current="page">
                            Принты
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="/handbook/sizes/"
                           class="text-white text-decoration-none <?= Functions::getActionName() == 'sizes' ? 'text-decoration-underline' : '' ?>"
                           aria-current="page">
                            Размеры
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="/handbook/materials/"
                           class="text-white text-decoration-none <?= Functions::getActionName() == 'materials' ? 'text-decoration-underline' : '' ?>"
                           aria-current="page">
                            Материалы
                        </a>
                    </li>
